...
//////////////////FIX THIS//////////////
 ...
 #ifdef __CHIPKIT__
   #warning using CHIPKIT
 #else
   #error Oops!  not the right board
 #endif
 #endif
#endif
...
#define HEATER_0_PIN       41  // Extruder
#define HEATER_1_PIN       38  // Bed
#define FAN_PIN            37  // Fan

#define TEMP_0_PIN          16  // Extruder
#define TEMP_1_PIN          15  // Bed
